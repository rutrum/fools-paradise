    ...
    pub fn get(self) -> SpriteData {
        ...
        match self {
            ...
            land => SpriteData {
                ...
                height: 16,
                flags: 0,
                data: vec![ 0x00,0x00,0x00,0x00,0xd0,0x00,0x00,0x07,0xf8,0x00,0x00,0x11,0xf5,0x00,0x00,0x6f,0xfa,0x80,0x00,0x1f,0xfc,0x00,0x00,0x47,0xfe,0x40,0x00,0xbf,0xf8,0x00,0x01,0x0f,0xfe,0x30,0x18,0xbf,0xff,0x8b,0x85,0xff,0xff,0xf4,0x12,0xff,0xff,0xe3,0x2f,0xff,0xff,0xfe,0x1f,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff ],
            },
            moon => SpriteData {
                width: 8,
                height: 8,
                flags: 0,
                data: vec![ 0x1c,0x06,0x03,0x83,0x83,0xc7,0x7e,0x3c ],
            },
            ship1 => SpriteData {
                width: 16,
                height: 16,
            ...
            speed => SpriteData {
                ...
                height: 8,
                flags: 1,
                data: vec![ 0x01,0x80,0x05,0x60,0x17,0xd8,0x57,0x56,0x9f,0x5a,0x25,0x68,0x09,0xa0,0x02,0x80 ],
            },
            spreader => SpriteData {
                width: 8,
                height: 8,
                flags: 1,
                data: vec![ 0x1b,0xc6,0x99,0xe6,0x64,0x19,0x2f,0x38,0x0d,0xbc,0x09,0x90,0x06,0x40,0x02,0x00 ],
            },
            sun => SpriteData {
                width: 8,
                height: 8,
                flags: 0,
                data: vec![ 0x3c,0x7e,0xff,0xff,0xff,0xff,0x7e,0x3c ],
            },
            turret => SpriteData {
                width: 16,
                height: 16,
